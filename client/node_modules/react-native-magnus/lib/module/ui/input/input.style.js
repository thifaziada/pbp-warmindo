...
export const getStyle = (theme, props, state) => {
  ...
  computedStyle.suffix = {
    ...
    alignSelf: props.suffix && /*#__PURE__*/isValidElement(props.suffix) && props.suffix.props.alignSelf,
    marginLeft: 5
  };
  computedStyle.prefix = {
    ...
    justifyContent: 'center',
    marginRight: 5,
    alignSelf: props.prefix && /*#__PURE__*/isValidElement(props.prefix) && props.prefix.props.alignSelf
